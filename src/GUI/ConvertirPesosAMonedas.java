...
public class ConvertirPesosAMonedas {
  public void PesoADolar(double monto){
    ...
    PaD = Double.valueOf(df.format(PaD));
  ...
  public void PesoAWon(double monto){
    ...
    PaW = Double.valueOf(df5.format(PaW));
